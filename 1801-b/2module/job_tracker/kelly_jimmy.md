...
- good use of confirmations when deleting
- use "only" in routes to limit open routes
- don't use AR calls in controllers, don't use model code in views
- reduce use of self references
